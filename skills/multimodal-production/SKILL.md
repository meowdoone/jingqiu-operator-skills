...
5. 输出前核对比例、尺寸、帧率、时长、字幕安全区、音轨与编码，采用用户/目标平台规格，不照搬教程固定 24/30fps 或模型套餐。
...
研究与出处见 [多模态专家研究](../../research/expert-multimodal-2026-09-08.md)。需要追溯方法或边界时读取；当前视频模型能力按实际工具文档验证，不将专家样片耗时、赞誉或生成成功率当作本项目承诺。
